...
describe('catalog tools', () => {
  ...
  describe('search_gear_catalog', () => {
    ...
    it('returns error result on API failure', async () => {
      ...
      const result = await callTool(tools, 'search_gear_catalog', { limit: 10, offset: 0, sort_order: 'asc' })
    ...
    it('fetches all items and returns sorted comparison', async () => {
      ...
      vi.mocked(api.get)
        .mockResolvedValueOnce({
          id: 1, name: 'Heavy Tent', brand: 'GenericBrand', category: 'tents',
          weight: 2000, price: 20000, ratingValue: 4.0, ratingCount: 50, productUrl: 'https://x.com',
        })
        .mockResolvedValueOnce({
          id: 2, name: 'Ultralight Tent', brand: 'GossamerGear', category: 'tents',
          weight: 700, price: 55000, ratingValue: 4.8, ratingCount: 200, productUrl: 'https://y.com',
        })
        .mockResolvedValueOnce({
          id: 3, name: 'Mid Tent', brand: 'MSR', category: 'tents',
          weight: 1200, price: 35000, ratingValue: 4.5, ratingCount: 150, productUrl: 'https://z.com',
        })
