...
export const configureOpenAPI = (app: OpenAPIHono<{ Bindings: Env; Variables: Variables }>) => {
  ...
  app.openAPIRegistry.registerComponent('schemas', 'Error', {
    type: 'object',
    properties: {
      error: {
        type: 'string',
  ...
  app.openAPIRegistry.registerComponent('schemas', 'Success', {
    type: 'object',
    properties: {
      success: {
        type: 'boolean',
  ...
  app.openAPIRegistry.registerComponent('schemas', 'PaginationParams', {
    type: 'object',
    properties: {
      page: {
        type: 'integer',
  ...
  app.openAPIRegistry.registerComponent('schemas', 'PaginationResponse', {
    type: 'object',
    properties: {
      total: {
        type: 'integer',
  ...
  app.openAPIRegistry.registerComponent('responses', 'ForbiddenError', {
  ...
  app.openAPIRegistry.registerComponent('responses', 'NotFoundError', {
  ...
  app.openAPIRegistry.registerComponent('responses', 'ServerError', {
