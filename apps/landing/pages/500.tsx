...
export default function Custom500() {
  return (
    <>
      <Head>
        <title>Something went wrong | PackRat</title>
        <meta
          name="description"
          content="An unexpected error occurred while loading PackRat. Try reloading the page or returning to the home page."
        />
