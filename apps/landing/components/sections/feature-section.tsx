...
export default function FeatureSection() {
  return (
    <section id="features" className="py-20 md:py-28 lg:py-36 relative overflow-hidden">
      ...
      <div className="absolute -top-40 -left-40 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-primary-50/30 via-primary-100/20 to-transparent blur-3xl dark:from-primary-900/20 dark:via-primary-800/10" />
      <div className="absolute top-1/4 right-0 w-1/3 h-1/3 bg-gradient-to-tl from-secondary-100/20 via-secondary-50/10 to-transparent blur-3xl dark:from-secondary-900/20 dark:via-secondary-800/10" />
