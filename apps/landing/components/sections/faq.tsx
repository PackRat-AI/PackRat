    ...
    <section id="faq" className="py-20 md:py-28 lg:py-36 relative overflow-hidden">
      <div className="container">
        <div className="mx-auto max-w-3xl text-center mb-12 md:mb-16">
          <div className="apple-badge mb-4">Got Questions?</div>
        ...
        <div className="mx-auto max-w-3xl">
            ...
            <Accordion type="single" collapsible className="w-full">
              {faqs.map((faq, index) => (
                <div key={faq.question}>
                  <AccordionItem value={`item-${index}`} className="border-b border-border/40">
                    <AccordionTrigger className="text-base md:text-lg font-medium text-foreground hover:text-apple-blue transition-colors py-4 px-1">
                      {faq.question}
                    </AccordionTrigger>
          ...
          <div className="mt-10 md:mt-12 text-center">
            <div className="apple-card p-4 md:p-6 space-y-3 md:space-y-4">
