...
export async function getUsers({
  ...
  if (error) throwOnError(error);
  return unwrap(data, 'users') as unknown as PaginatedResponse<AdminUser>;
}
...
export async function getPacks({
  ...
  if (error) throwOnError(error);
  return unwrap(data, 'packs') as unknown as PaginatedResponse<AdminPack>;
}
...
export async function getCatalogItems({
  ...
  if (error) throwOnError(error);
  return unwrap(data, 'catalog') as unknown as PaginatedResponse<AdminCatalogItem>;
}
