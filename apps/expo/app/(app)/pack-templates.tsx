	...
	return (
		<View className="mt-2 flex-row flex-wrap">
			{tags.map((tag, index) => (
				<View
					key={tag}
					className="mb-1 mr-1 rounded-full bg-muted px-2 py-0.5 dark:bg-gray-50/10"
				>
			...
			<ScrollView className="flex-1">
				...
				<View className="mx-4 my-2 mb-6 rounded-lg bg-card p-4">
					...
					<Text variant="body" className="mb-4">
						Templates allow you to quickly create new packs based on proven
						configurations. Use them as starting points and customize for
						specific trips.
					</Text>
					<View className="rounded-md bg-muted p-3 dark:bg-gray-50/10">
						...
						<Text variant="footnote" className="mt-1 text-muted-foreground">
							After a successful trip, save your pack as a template to reuse for
