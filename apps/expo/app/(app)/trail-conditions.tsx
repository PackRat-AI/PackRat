...
function TrailConditionCard({
	trail,
}: {
	trail: (typeof TRAIL_CONDITIONS)[0];
}) {
	return (
				...
				<View className="mx-4 my-2 mb-6 rounded-lg bg-card p-4">
					<View className="rounded-md bg-muted p-3 dark:bg-gray-50/10">
						<Text variant="footnote" className="text-muted-foreground">
							Trail conditions are crowdsourced from hikers and may not reflect
							current situations. Always check with local authorities for
