...
import type { Trip } from 'expo-app/features/trips/types';
...
function countdownLabel(dateString: string): string {
...
function TripRow({ trip, onPress }: { trip: Trip; onPress: (trip: Trip) => void }) {
  ...
  const countdown = trip.startDate ? countdownLabel(trip.startDate) : '';
    ...
    <View className="flex-1 items-center justify-center gap-6 px-8">
      ...
      <View className="items-center gap-2">
        ...
        <Text variant="subhead" className="text-center text-muted-foreground">
          You have no trips scheduled. Plan your next adventure and it will appear here.
        </Text>
      </View>
