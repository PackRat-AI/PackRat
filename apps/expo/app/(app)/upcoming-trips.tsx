...
import { List, ListItem } from "expo-app/components/nativewindui/List";
    ...
    <View className="flex-row">
      {members.map((member, index) => (
        <Avatar
          key={member.id}
          className={cn(
            "h-6 w-6 border border-background",
            index > 0 && "-ml-2"
          )}
        >
      ...
      <ScrollView className="flex-1">
            ...
            return (
              <ListItem
                ...
                rightView={
                  <View className="flex-row items-center">
                    <PackStatus
                      status={trip.packStatus}
                      completion={trip.packCompletion}
                    />
                  </View>
                }
            ...
            <View className="mb-2 flex-row justify-between">
              <View className="flex-row items-center">
                ...
                <Text variant="subhead">
                  High: {selectedTrip.weather.highTemp}
                </Text>
              </View>
              <View className="flex-row items-center">
                <Icon
                ...
                />
                <Text variant="subhead">
                  Low: {selectedTrip.weather.lowTemp}
                </Text>
              </View>
              <View className="flex-row items-center">
                <Icon
                ...
                />
                <Text variant="subhead">
                  Precip: {selectedTrip.weather.precipitation}
                </Text>
              </View>
            </View>
        ...
        <View className="mx-4 my-4 mb-8 rounded-lg bg-card">
          ...
          <View className="p-4 pt-0">
            <Text variant="footnote" className="text-muted-foreground">
              {TRIP_CHECKLIST.filter((item) => item.completed).length} of{" "}
              {TRIP_CHECKLIST.length} tasks completed
            </Text>
          </View>
        </View>
      </ScrollView>
