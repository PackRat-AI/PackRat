...
const ACTIVITIES: Array<{
  ...
  { key: 'hiking', label: 'Hiking', icon: 'walk', description: 'Day hikes and trail walking' },
  {
    key: 'backpacking',
    label: 'Backpacking',
    icon: 'bag-personal',
  ...
  { key: 'custom', label: 'Custom', icon: 'cog', description: 'Other outdoor activities' },
];
            ...
            {ACTIVITIES.map((activity) => (
              ...
              >
                <View className="mr-3 h-10 w-10 items-center justify-center rounded-full bg-neutral-300 dark:bg-neutral-600">
                  <Icon name={activity.icon} size={20} color={colors.grey} />
                </View>
