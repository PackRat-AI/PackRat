...
const createPackWeightHistoryEntry = async (
  packWeightHistoryEntry: PackWeightHistoryEntry
) => {
  try {
...
export const packWeigthHistoryStore = observable<
  Record<string, PackWeightHistoryEntry>
>({});
