...
import {
  activeFilterAtom,
  searchValueAtom,
} from "expo-app/features/packs/packListAtoms";
...
export function PackListScreen() {
  ...
  const packs =
    selectedTypeIndex === USER_PACKS_INDEX ? userPacks : allPacksQuery.data;
  ...
  const filteredPacks = packs?.filter((pack) => {
    ...
    const matchesCategory =
      activeFilter === "all" || pack.category === activeFilter;
